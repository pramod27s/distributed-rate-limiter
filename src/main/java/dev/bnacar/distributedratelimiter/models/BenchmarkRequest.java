...
public class BenchmarkRequest {
    ...
    public String getStandardApiKey() {
        return standardApiKey;
    }

    public void setStandardApiKey(String standardApiKey) {
        this.standardApiKey = standardApiKey;
    }

    public String getPremiumApiKey() {
        return premiumApiKey;
    }

    public void setPremiumApiKey(String premiumApiKey) {
