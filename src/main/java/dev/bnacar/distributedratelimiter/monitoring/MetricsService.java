...
public class MetricsService {
    ...
    private final Deque<MetricsResponse.RequestEvent> recentEvents = new ArrayDeque<>();
    ...
    public void recordRequestEvent(String key,
                                   String apiKey,
                                   String userType,
                                   String algorithm,
                                   int tokensRequested,
                                   boolean allowed) {
        MetricsResponse.RequestEvent event = new MetricsResponse.RequestEvent(
            key + "-" + System.nanoTime(),
    ...
    public MetricsResponse getMetrics() {
        ...
        java.util.List<MetricsResponse.RequestEvent> eventsSnapshot;
        synchronized (recentEvents) {
