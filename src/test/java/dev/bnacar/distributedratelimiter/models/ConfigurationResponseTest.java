...
class ConfigurationResponseTest {
    ...
    void testConfigurationResponseCreation() {
        ...
        ConfigurationResponse response = new ConfigurationResponse(
            capacity, refillRate, cleanupIntervalMs, algorithm, keyConfigs, patternConfigs
        );
    ...
    void testNullConfigMaps() {
        // When
        ConfigurationResponse response = new ConfigurationResponse(
            100, 10, 60000L, RateLimitAlgorithm.SLIDING_WINDOW, null, null
        );
    ...
    void testDefensiveCopies() {
        ...
        ConfigurationResponse response = new ConfigurationResponse(
            100, 10, 60000L, RateLimitAlgorithm.TOKEN_BUCKET, keyConfigs, new HashMap<>()
        );
    ...
    void testEmptyConfigMaps() {
        ...
        // When
        ConfigurationResponse response = new ConfigurationResponse(
            100, 10, 60000L, RateLimitAlgorithm.LEAKY_BUCKET, emptyKeyConfigs, emptyPatternConfigs
        );
